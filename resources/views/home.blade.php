                        ...
                        <div id="rule-group">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-3">
                                    <select class="form-control" name="condition[]" aria-labelledby="dropdownMenuButton">
                                        <option value="contains" {{$rule->condition=='contains'?' selected="selected"' : ''}}>Pages that
                                            contain</option>
                                        <option value="equals" {{$rule->condition=='equals'?' selected="selected"' : ''}}>A specific page
                                        </option>
                                        <option value="starts_with" {{$rule->condition=='starts_with'?' selected="selected"' : ''}}>Page
                                            starting with</option>
                                        <option value="end_with" {{$rule->condition=='end_with'?' selected="selected"' : ''}}>Page ending
                                            with</option>
                                    </select>
                                </div>
                                <div class="col-md-5">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="uri[]" placeholder="path name" required aria-label="path name" aria-describedby="basic-addon1" value={{$rule->uri}}>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-5">
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon1">www.domain.com/</span>
                                        <input type="text" class="form-control" name="uri[]" placeholder="path name" aria-label="path name" aria-describedby="basic-addon1" required>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="alert_text" placeholder="Alert text" value="{{isset($rules)?$rules->alert_text:''}}">
                                </div>
                                @error('alert_text')
    ...
    function addRule(e) {
        ...
        <div class="row mb-2">
            ...
            <div class="col-md-5">
                <div class="input-group">
                    <span class="input-group-text" id="basic-addon1">www.domain.com/</span>
                    <input type="text" class="form-control" name="uri[]" placeholder="path name"
                        aria-label="path name" aria-describedby="basic-addon1">
                </div>
            </div>
            <div class="col-sm-2">
                <div class="btn btn-danger" onClick="removeRule(this);">
