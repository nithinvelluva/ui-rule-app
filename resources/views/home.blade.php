                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="uri[]" placeholder="path name" required
                                                aria-label="path name" aria-describedby="basic-addon1" value={{$rule->uri}}>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="uri[]" placeholder="path name"
                                                aria-label="path name" aria-describedby="basic-addon1" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
